...
namespace AnalyzerRunner
{
    internal class CodeFixEquivalenceGroup
    {
        ...
        internal static async Task<ImmutableArray<CodeFixEquivalenceGroup>> CreateAsync(CodeFixProvider codeFixProvider, ImmutableDictionary<ProjectId, AnalysisResult> analysis, Solution solution, CancellationToken cancellationToken)
        {
            ...
            foreach (var projectDiagnostics in analysis)
            {
                foreach (var diagnostic in projectDiagnostics.Value.GetAllDiagnostics())
                {
